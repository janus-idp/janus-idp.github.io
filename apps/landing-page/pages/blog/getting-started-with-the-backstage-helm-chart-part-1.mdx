...
```yaml filename="values-minikube-default.yaml"
upstream:
  backstage:
    extraEnvVars:
...
```bash
helm install -n backstage --create-namespace backstage janus-idp/backstage -f values-minikube-default.yaml
```
