...
![API entities in the Backstage catalog](/images/blog/exposing-your-3scale-apis/3scale.png)

## Next steps

<ContributePlugin repoHref="https://github.com/janus-idp/backstage-plugins/tree/main/plugins/3scale-backend" />
