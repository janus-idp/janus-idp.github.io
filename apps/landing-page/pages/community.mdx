...
Start by joining our community. We have a [janus-idp](https://janus-idp.slack.com/archives/C04EDTPJRK5) Slack workspace that you can join and meet other Janus users. In all our communications, on whatever platform, we expect everyone to follow a code of contact.
