...
[Janus](https://janus-idp.io/) is the upstream community of the Red Hat Developer Hub. There are a lot of contribution opportunities like plugin development, fixes and contributing to the IDP initiative. As a team we have contributed to the Janus Project on plugin development and fixes to the [IDP](https://showcase.janus-idp.io/)
