  ...
  return (
    <header className="hero hero--primary text-center relative overflow-hidden px-0 py-16">
      <div className="container">
        <h1 className="hero__title">Janus Plugins for Backstage</h1>
        <p className="hero__subtitle">Have a plugin idea?</p>
        <div className="flex items-center justify-center">
          <Link className="button button--secondary button--lg" to="https://github.com/janus-idp/backstage-plugins/issues/new?assignees=&labels=plugin&projects=&template=plugin.yaml&title=%F0%9F%94%8C+Plugin%3A+">
